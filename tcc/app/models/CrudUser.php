...
class CrudUser
{
    ...
    public function getUsers()
    {
        ...
        foreach ($cad_user as $user) {
            $listaUsers[] = new Usuario($user['cpf'], $user['nome'], $user['data_nasc'], $user['ocupacao'], $user['sexo'], $user['usuario'], $user['senha'],$user['tipo_id']);
        }
    ...
    public function getUser($usuario, $senha)
    {
        ...
        $Users[] = new Usuario($user['cpf'], $user['nome'], $user['data_nasc'], $user['ocupacao'], $user['sexo'], $user['usuario'], $user['senha'],$user['tipo_id']);
    ...
    public function atualizaUser(Usuario $user, $cpf)
    {
        $this->conexao = DBConnection::getConexao();
        $dados[] = $user->getCpf();
        $dados[] = $user->getNome();
